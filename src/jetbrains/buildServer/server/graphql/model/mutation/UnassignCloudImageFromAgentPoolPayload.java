...
public class UnassignCloudImageFromAgentPoolPayload {
  @NotNull
  ...
  public UnassignCloudImageFromAgentPoolPayload(@NotNull CloudImage cloudImage, @NotNull AgentPool agentPool) {
