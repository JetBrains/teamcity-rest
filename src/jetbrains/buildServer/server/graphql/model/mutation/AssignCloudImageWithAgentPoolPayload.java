...
public class AssignCloudImageWithAgentPoolPayload {
  @NotNull
  ...
  public AssignCloudImageWithAgentPoolPayload(@NotNull CloudImage cloudImage, @NotNull AgentPool agentPool) {
