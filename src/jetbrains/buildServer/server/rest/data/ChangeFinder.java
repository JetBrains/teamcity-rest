 ...
 *         Date: 12.05.13
 */
@LocatorResource(value = "ChangeLocator", extraDimensions = {AbstractFinder.DIMENSION_ID, Locator.LOCATOR_SINGLE_VALUE_UNUSED_NAME, PagerData.START, PagerData.COUNT})
