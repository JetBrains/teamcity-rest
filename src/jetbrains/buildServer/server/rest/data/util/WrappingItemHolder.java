 ...
 */
public class WrappingItemHolder<UNWRAPPED, WRAPPED> implements FinderDataBinding.ItemHolder<WRAPPED> {
  private final Function<UNWRAPPED, WRAPPED> myWrapper;
  private final FinderDataBinding.ItemHolder<? extends UNWRAPPED> myDelegate;

  public WrappingItemHolder(@NotNull final FinderDataBinding.ItemHolder<? extends UNWRAPPED> delegate, @NotNull Function<UNWRAPPED, WRAPPED> wrapper) {
    myWrapper = wrapper;
    myDelegate = delegate;
  }
  ...
  public WrappingItemHolder(@NotNull final Stream<? extends UNWRAPPED> items, @NotNull Function<UNWRAPPED, WRAPPED> wrapper) {
    myWrapper = wrapper;
    myDelegate = FinderDataBinding.getItemHolder(items);
  }
