 ...
 */
public class DeduplicatingItemHolder<P> implements ItemHolder<P> {
  @NotNull
  private final ItemHolder<P> myItemHolder;
  @NotNull
  private final DuplicateChecker<P> myDuplicateChecker;

  public DeduplicatingItemHolder(@NotNull final ItemHolder<P> itemHolder, @NotNull final DuplicateChecker<P> duplicateChecker) {
