...
public class LocatorName {
  ...
  public static final String PROBLEM = "ProblemLocator";
  public static final String TAG = "TagLocator";
  public static final String TEST_OCCURRENCE = "TestOccurrenceLocator";
