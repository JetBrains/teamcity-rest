...
@XmlType(name = "two-factor-credentials", propOrder = {"secretKey", "recoveryKeys"})
...
public class TwoFactorCredentials {
  ...
  public TwoFactorCredentials(@NotNull String secretKey, @NotNull TwoFactorRecoveryKeys recoveryKeys) {
