...
@Extension(properties = @ExtensionProperty(name = ExtensionType.X_DESCRIPTION, value = "Represents a snapshot dependency relation."))
@XmlType
public class PropEntitySnapshotDep extends PropEntity implements PropEntityEdit<Dependency> {
  ...
  public PropEntitySnapshotDep(@NotNull final Dependency dependency,
    ...
    init(dependency.getDependOnExternalId(), null, SNAPSHOT_DEPENDENCY_TYPE_NAME, null,
         !buildType.getOwnDependencies().contains(dependency), properties, fields, context); //can optimize by getting getOwnDependencies in the caller
