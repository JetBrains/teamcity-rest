...
public class MatrixConfiguration {
  ...
  private MatrixParameterDescriptions myParameters;
  ...
  public MatrixConfiguration(@NotNull BuildPromotion matrixPromotion, @NotNull Fields fields, @NotNull BeanContext beanContext) {
    myEnabled = SplitBuildsFeatureUtil.isMatrixBuild(matrixPromotion);
    if(!myEnabled) {
      myParameters = null;
      myDependencies = null;
    } else {
      myParameters = ValueWithDefault.decideDefault(
        ...
        () -> new MatrixParameterDescriptions(matrixPromotion, fields.getNestedField("parameters"))
      );
      myDependencies = ValueWithDefault.decideDefault(
        fields.isIncluded("dependencies", false, true),
        () -> new MatrixDependencies(SplitBuildsFeatureUtil.getMatrixDependencies(matrixPromotion), fields.getNestedField("dependencies"), beanContext)
      );
    }
  }
  ...
  public MatrixParameterDescriptions getParameters() {
    return myParameters;
  }
