...
@Provider
public class DuplicateExternalIdExceptionMapper extends ExceptionMapperBase<DuplicateExternalIdException> {
  @Override
  public ResponseData getResponseData(@NotNull DuplicateExternalIdException e) {
