...
@Provider
public class DuplicateTemplateNameExceptionMapper extends ExceptionMapperBase<DuplicateTemplateNameException> {
  @Override
  public ResponseData getResponseData(@NotNull DuplicateTemplateNameException e) {
