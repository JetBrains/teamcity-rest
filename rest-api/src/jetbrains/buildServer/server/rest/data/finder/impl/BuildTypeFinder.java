...
public class BuildTypeFinder extends AbstractFinder<BuildTypeOrTemplate> {
  ...
  public static String getLocatorCompatible(@NotNull final SBuildAgent agent) {
    ...
    locator.setDimension(COMPATIBLE_AGENT, AgentFinder.getLocator(agent));
    locator.setDimension(DIMENSION_PROJECT, Locator.getStringLocator(ProjectFinder.DIMENSION_ARCHIVED, "false"));
