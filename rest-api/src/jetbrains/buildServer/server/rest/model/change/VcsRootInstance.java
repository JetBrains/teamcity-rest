...
public class VcsRootInstance {
  ...
  public VcsRootInstance(final jetbrains.buildServer.vcs.VcsRootInstance root, final @NotNull Fields fields, @NotNull final BeanContext beanContext) {
    ...
    modificationCheckInterval = ValueWithDefault.decideDefault(fields.isIncluded("modificationCheckInterval", false), () -> root.getEffectiveModificationCheckInterval());
    commitHookMode = ValueWithDefault.decideDefault(fields.isIncluded(COMMIT_HOOK_MODE, false, false), () -> !root.isPollingMode());
  }
