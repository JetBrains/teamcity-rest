...
public class Problem {
  ...
  public Problem(final @NotNull ProblemWrapper problem,
    ...
    investigations = ValueWithDefault.decideDefault(fields.isIncluded("investigations", false), () ->
      new Investigations(problem.getInvestigations(), new SinglePagePagerData(InvestigationRequest.getHref(problem)), fields.getNestedField("investigations"), beanContext)
    );
