 ...
 *         Date: 30/11/2015
 */
public class PagerDataImplTest extends BaseServerTestCase {
  ...
  @Test
  public void testPaginitationWithUnlimitedCount() throws URISyntaxException {
    List<String> items = IntStream.range(0, 10).mapToObj(Integer::toString).collect(Collectors.toList());

    PagedSearchResult<String> pagedResult = new PagedSearchResult<>(
      items,
      null,
      null,
      10L,
    ...
    check(
      ...
      "lookupLimit:10",
      pagedResult,
      "/smth?locator=lookupLimit:10",
      "/smth?locator=lookupLimit:20,start:10",
      null
    );
  }
  ...
  private void check(@NotNull final String currentHrefPath, @Nullable final String currentLocator, @NotNull final PagedSearchResult<String> pagedResult,
    ...
    final PagerData pagerData =
      new PagerDataImpl(UriBuilder.fromUri(new URI("http://some.url:8111/teamcity" + currentHrefPath + (currentLocator != null ? "?locator=" + currentLocator : ""))), "/teamcity",
