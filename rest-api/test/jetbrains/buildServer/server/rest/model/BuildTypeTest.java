...
public class BuildTypeTest extends BaseFinderTest<BuildTypeOrTemplate> {
  ...
  private UriInfo myMockUriInfo;
  private FakeHttpServletRequest myFakeRequest;
  ...
  public void setUp() throws Exception {
    ...
    myMockUriInfo = mockUriInfo();
    myFakeRequest = new FakeHttpServletRequest();
  }
  ...
  public void testBranches() throws ExecutionException, InterruptedException {
    ...
    Branches branches = buildTypeRequest.serveBranches("id:testBT", null, null, myMockUriInfo, myFakeRequest);
    ProjectRequestTest.assertBranchesEquals(branches.branches, "<default>", true, null);

    branches = buildTypeRequest.serveBranches("id:testBT", null, Fields.ALL_NESTED.getFieldsSpec(), myMockUriInfo, myFakeRequest);
    ...
    branches = buildTypeRequest.serveBranches("id:testBT", null, null, myMockUriInfo, myFakeRequest);
    ...
    branches = buildTypeRequest.serveBranches("id:testBT", "policy:ALL_BRANCHES", null, myMockUriInfo, myFakeRequest);
    ...
    branches = buildTypeRequest.serveBranches("id:testBT", "policy:ALL_BRANCHES", Fields.ALL_NESTED.getFieldsSpec(), myMockUriInfo, myFakeRequest);
    ...
    branches = buildTypeRequest.serveBranches("id:testBT", "default:true", null, myMockUriInfo, myFakeRequest);
    ProjectRequestTest.assertBranchesEquals(branches.branches,"master", true, null);
    ...
    checkException(LocatorProcessException.class,
                   () -> buildTypeRequest.serveBranches("id:testBT", "changesFromDependencies:any", null, myMockUriInfo, myFakeRequest),
                   "searching with wrong changesFromDependencies");

    checkException(BadRequestException.class,
                   () -> buildTypeRequest.serveBranches("id:testBT", "policy:INVALID_POLICY", null, myMockUriInfo, myFakeRequest),
                   "searching with wrong changesFromDependencies");
  ...
  public void testBranchesCaseDiff() throws ExecutionException, InterruptedException {
    ...
    Branches branches = buildTypeRequest.serveBranches("id:testBT", "policy:ALL_BRANCHES", Fields.ALL_NESTED.getFieldsSpec(), myMockUriInfo, myFakeRequest);
    assertEquals("<default>", branches.branches.get(0).getInternalName());
  ...
  public void testLinks() {
    ...
    assertEquals("http://localhost:8111/buildConfiguration/testBT?mode=builds", webLinks.getConfigurationHomePageUrl(bt));
    assertEquals("/buildConfiguration/testBT?mode=builds", relativeWebLinks.getConfigurationHomePageUrl(bt));
...
//    parameterEquals(find(buildType.getSettings().getProperties(), "allowExternalStatus"), "allowExternalStatus", "false", null); //settings to default value does not set it in API...
  ...
  private UriInfo mockUriInfo() {
    UriInfo mock = org.mockito.Mockito.mock(UriInfo.class);
    UriBuilder uriBuilder = org.mockito.Mockito.mock(UriBuilder.class, Answers.CALLS_REAL_METHODS);

    Mockito.when(uriBuilder.build()).thenReturn(STUB_URI);
    Mockito.when(mock.getRequestUriBuilder()).thenReturn(uriBuilder);

    return mock;
  }

  private static final URI STUB_URI = URI.create("http://stub.uri");
