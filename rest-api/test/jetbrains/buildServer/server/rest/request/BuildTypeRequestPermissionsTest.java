...
public class BuildTypeRequestPermissionsTest extends BaseFinderTest<BuildTypeOrTemplate> {
  ...
  public void updateArtifactDepsRequiresPermission() throws Throwable {
    ...
    newDep.properties.setProperties(Arrays.asList(new Property(new SimpleParameter("revisionName", "aaa"), false, Fields.LONG, myFixture),
  ...
  public void updateAgentRequirementsRequiresPermission() throws Throwable {
    ...
    newRequirement.properties.setProperties(Collections.singletonList(new Property(new SimpleParameter("property-name", "aaa"), false, Fields.LONG, myFixture)));
