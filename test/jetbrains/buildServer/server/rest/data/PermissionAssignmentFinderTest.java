...
public class PermissionAssignmentFinderTest extends BaseFinderTest<PermissionAssignmentData>{
  ...
  public void testProjectPermissions() throws Exception {
    ...
    checkUnordered(null, pa(Permission.CHANGE_OWN_PROFILE), pa(Permission.RUN_BUILD, projectId), pa(Permission.VIEW_PROJECT, projectId), pa(Permission.VIEW_PROJECT, getRootProject().getProjectId()),
                   pa(Permission.RUN_BUILD, myProject11.getProjectId()), pa(Permission.VIEW_PROJECT, myProject11.getProjectId()));
    checkUnordered("global:any", pa(Permission.CHANGE_OWN_PROFILE), pa(Permission.RUN_BUILD, projectId), pa(Permission.VIEW_PROJECT, projectId), pa(Permission.VIEW_PROJECT, getRootProject().getProjectId()), pa(Permission.RUN_BUILD, myProject11.getProjectId()), pa(Permission.VIEW_PROJECT, myProject11.getProjectId()));
    checkUnordered("global:true", pa(Permission.CHANGE_OWN_PROFILE));
    checkUnordered("global:false", pa(Permission.RUN_BUILD, projectId), pa(Permission.VIEW_PROJECT, projectId), pa(Permission.VIEW_PROJECT, getRootProject().getProjectId()), pa(Permission.RUN_BUILD, myProject11.getProjectId()), pa(Permission.VIEW_PROJECT, myProject11.getProjectId()));
